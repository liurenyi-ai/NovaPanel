...
[releases page](https://github.com/ruofei-nova/NovaPanel/releases), extract it, and run
...
The repo's [`deploy/`](https://github.com/ruofei-nova/NovaPanel/tree/main/deploy)

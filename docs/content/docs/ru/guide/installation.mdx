...
[страницы релизов](https://github.com/ruofei-nova/NovaPanel/releases), распаковать его и
...
В каталоге [`deploy/`](https://github.com/ruofei-nova/NovaPanel/tree/main/deploy)

...
export const sections: readonly Section[] = [
...

  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        summary: 'Check whether a newer Nova Panel release is available on GitHub.',
      },
      {
        method: 'GET',
...

  {
    ...
    title: 'Nodes',
    description:
      'Manage remote Nova Panel instances acting as nodes for a central panel. All endpoints under /panel/api/nodes.',
    endpoints: [
      {
        method: 'GET',
...

  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        summary: 'Restart the entire Nova Panel process after a 3-second grace period. The connection drops immediately; the panel comes back online ~5-10 seconds later.',
      },
      {
        method: 'POST',

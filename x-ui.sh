...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/ruofei-nova/NovaPanel/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_dev() {
    ...
    XUI_UPDATE_TAG="dev-latest" bash <(curl -Ls https://raw.githubusercontent.com/ruofei-nova/NovaPanel/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    if replace_xui_script "https://raw.githubusercontent.com/ruofei-nova/NovaPanel/main/x-ui.sh" "false"; then
...
legacy_version() {
    ...
    install_command="bash <(curl -Ls "https://raw.githubusercontent.com/ruofei-nova/NovaPanel/v$tag_version/install.sh") v$tag_version"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/ruofei-nova/NovaPanel/main/install.sh)${plain}"
    echo ""
...
update_shell() {
    if replace_xui_script "https://github.com/ruofei-nova/NovaPanel/raw/main/x-ui.sh" "true"; then
